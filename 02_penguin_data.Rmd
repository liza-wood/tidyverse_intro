...
The Palmer Station penguins data is a tidy dataset related to three species of Antarctic penguins from Horst, Hill, and Gorman (2020)^[Horst AM, Hill AP, Gorman KB (2020). palmerpenguins: Palmer Archipelago (Antarctica) penguin data. R package version 0.1.0. https://allisonhorst.github.io/palmerpenguins/. doi: 10.5281/zenodo.3960218.].
...
Together this tutorial uses data collected from pengiuns across three islands in the Palmer archipelago and weather sensing technology at the US Palmer Station.

```{r echo=FALSE, out.width = c("50%","40"), fig.align= 'center', fig.cap = c('Artwork by @allison_horst', 'Palmer archipelago, image from Gorman et al. 2014 Figure 1')}
